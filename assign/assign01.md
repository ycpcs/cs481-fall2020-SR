...
Your team should then write a 2-4 page report describing your chosen/assigned project.  In order to properly define your team's work, you will need to research the existing work, and discuss with the Swarm Robotics Capstone Engineering team what needs to be created, refactored, modified, and/or added.
...
We **strongly** encourage you to meet with the faculty and the Sewarm Robotics Capstone Engineering team to discuss project ideas before you submit your formal project proposal.
...
You may use the physical space and computing equipment as you see fit.  Please be considerate of the needs of other teams, and please try to keep the environment neat and well-organized.  The back of the KEC118 is already reserved for the Radio Telescope project.  I suggest reserving the left middle bench for the Swarm Robotics team, but I'm not sure how this is going to work for this academic year, due to Covid-19.
